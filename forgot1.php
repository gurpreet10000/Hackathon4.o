...
if($_POST)
{
	...
	$subject = "Reset password template";
	 ...
	 $header = "from :13dce098@nirmauni.ac.in";
	...
	header("location:forgot1.php?msg=please check email and reset your password");

	}
	else{
		header("location:forgot1.php?msg1=Wrong Email");
	}
}
?>
<!DOCTYPE html>
		...
		<div class="signin-form">
			...
			<form action=""  method="post">
				...
				<div class="form-actions">
					<input type="submit" value="Reset Password" class="signin-btn bg-primary">
				</div> <!-- / .form-actions -->
			</form>
			<!-- / Form -->
		...
		<?php } ?> 
			...
			<div class="password-reset-form" id="password-reset-form">
				...
				<form action="forgot.php" id="password-reset-form_id">
					...
					<div class="form-actions">
						<input type="submit" value="SEND PASSWORD RESET LINK" class="signin-btn bg-primary" name="reg_user1">
					</div> <!-- / .form-actions --> 
				</form>
				<!-- / Form -->
			</div>
