...
<!-- Demo script --> <script src="assets/demo/demo.js"></script> <!-- / Demo script -->
	...
	<div class="signup-container">
		...
		<div class="signup-form">
			<form id="signup-form_id" method="post" action="insert_master.php" enctype="multipart/form-data">
				...
				<div class="form-group w-icon">
					<input type="text" name="cname" id="name_id" class="form-control input-lg" placeholder="Company Name">
					<span class="fa fa-info signup-form-icon"></span>
				</div>

				<div class="form-group w-icon">
					<input type="text" name="email" id="email_id" class="form-control input-lg" placeholder="Company E-mail">
					<span class="fa fa-envelope signup-form-icon"></span>
				</div>

				<div class="form-group w-icon">
					<input type="text" name="cperson" id="cperson" class="form-control input-lg" placeholder="Contact Person Name">
					<span class="fa fa-user signup-form-icon"></span>
			    </div>

			    <div class="form-group w-icon">
					<input type="text" name="contactno" id="contactno" class="form-control input-lg" placeholder="Contact Number">
					<span class="fa fa-phone signup-form-icon"></span>
			    </div>

			    <div class="form-group w-icon">
			    	<input type="text" name="address" id="address" class="form-control input-lg" placeholder="Company's Address">
				...
				<div class="form-group w-icon">
					<input type="password" name="cpassword" id="cpassword_id" class="form-control input-lg" placeholder="Confirm Password">
					<span class="fa fa-lock signup-form-icon"></span>
				</div>

				 <div class="form-group w-icon">
			    	<input type="file" name="photo" class="form-control input-lg" placeholder="Company Logo">
			    	<span class="fa fa-map-marker signup-form-icon"></span>
			    </div>
				...
				<div class="form-actions">
					<input type="submit" value="SIGN UP" class="signup-btn bg-primary" name="reg_company">
				</div>
			</form>
			<!-- / Form -->
		...
		Already have an account? <a href="pages-companysignin.php">Sign In</a>
	</div>
