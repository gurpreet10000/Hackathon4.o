...
if($_POST){
	...
	$query=$d->select("members","username='$username' AND password='$password' AND active_flag='$active_flag'");
	...
	else if($active_flag == 1)
	{
		...
		header("location:pages-companysignin.php?msg1=wrong user name and password");
	}
...
<!-- Demo script --> <script src="assets/demo/demo.js"></script> <!-- / Demo script -->
		...
		<div class="signin-form">
			...
			<form action="" id="signin-form_id" method="post">
				...
				<div class="form-actions">
					...
					<a href="forgot1.php" class="forgot-password" >Forgot your password?</a>
				</div> <!-- / .form-actions -->
			</form>
			<!-- / Form -->
	...
	<div class="not-a-member">
		Not a member? <a href="pages-companysignup.php">Sign up now</a>
	</div>
	<?php 
	if($_GET['msg']){
